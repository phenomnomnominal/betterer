...
import { BettererFilesResult, BettererFilesDeserialised, BettererFileTestDiff, BettererFileIssue, BettererFileIssueDeserialised } from './types';
...
export function constraint(current: BettererFilesResult, previous: BettererFilesDeserialised): BettererFileTestConstraintResult {
