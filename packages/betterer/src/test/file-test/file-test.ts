...
import { BettererFileExcluded, BettererFilesResult, BettererFilesDeserialised, BettererFileIssuesMapSerialised, BettererFileTestFunction, BettererFileIssue, BettererFileTestDiff } from './types';

export class BettererFileTest extends BettererTest<BettererFilesResult, BettererFilesDeserialised, BettererFileIssuesMapSerialised> {
    ...
    constructor(fileTest: BettererFileTestFunction) {
        super({
            test: async (run: BettererRun): Promise<BettererFilesResult> => {
                ...
                return new BettererFiles(Object.keys(result).map((filePath) => {
