...
import { BettererTestOptions, BettererTestConstraint, BettererTestGoal, BettererTestFunction, BettererDiffer, BettererPrinter, BettererSerialiser } from './types';
import { BettererTestState } from './test-state';

const IS_BETTERER_TEST = 'isBettererTest';

export class BettererTest<ResultType = unknown, DeserialisedType = ResultType, SerialisedType = ResultType> extends BettererTestState {
  ...
  private _createGoal(options: BettererTestOptions<ResultType, DeserialisedType, SerialisedType>): BettererTestGoal<ResultType> {
