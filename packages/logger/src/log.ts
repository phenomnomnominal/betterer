 ...
 *
 * Log a set of {@link BettererLog | `BettererLog`} instructions
 * with a given {@link BettererLogger | `BettererLogger`}.
 *
 * Useful for when you want to capture logging information, but delay when it
