...
const PACKAGES_DIR = path.resolve(dirname, '../../../packages');
const GOLDENS_DIR = path.resolve(dirname, '../../../goldens/api');
const TEMP_DIR = path.resolve(dirname, '../../../goldens/temp');
