...
import { BettererTaskLog, BettererLoggerAsync } from '@betterer/logger';
...
export async function run(logger: BettererLoggerAsync, packageName: string): Promise<string | BettererTaskLog> {
